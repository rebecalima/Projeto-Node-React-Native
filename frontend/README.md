...
yarn start - terminal visual studio dentro da pasta.

* React tem um live reload.
* React procura pela div id root para colocar todo o conteúdo dela que está no index, porque toda aplicaçãO é gerada pelo js e
    não pelo html em si.
